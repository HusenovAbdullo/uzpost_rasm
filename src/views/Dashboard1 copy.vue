...
export default {
  ...
  data() {
    return {
      barcode: "",
      fish: this.fish || "", // Agar parametr bo'lsa, avtomatik o'rnatiladi
      region: this.region || "", // Region parametrini avtomatik o'rnatish
      district: this.district || "", // District parametrini avtomatik o'rnatish
      post_name: "",
      date: "",
      images: [],
      currentPage: 1,
  ...
  methods: {
    ...
    goToStatistics() {
      this.$router.push('/statistika'); // Router orqali statistikaga o'tish
    },
    updateDistricts() {
